...
public class AggregateStatsTest {
    ...
    public void testNullValues() throws Exception {
        List<Row> inputRows = Arrays.asList(
            new Row("data_transfer_size", null).add("response_time", "500ms"),
            new Row("data_transfer_size", "1MB").add("response_time", null)
        );
        ...
        double totalMB = 1; // Only one valid value
        double totalSec = 0.5; // Only one valid value
